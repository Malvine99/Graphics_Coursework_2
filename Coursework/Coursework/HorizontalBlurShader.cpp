...
{
	initShader(L"mouse_vs.cso", L"horizontalBlur_ps.cso");
}
...
void HorizontalBlurShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, ID3D11ShaderResourceView* mask, ID3D11ShaderResourceView* scene, float width)
{
